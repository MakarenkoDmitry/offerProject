      ...
      <div>
        ...
        <section className=" py1">
          <div className="clearfix">
            ...
            <div className="left col_half a-right">
            {!!vkPost.items.length &&
              <a href={vkPost.link} target="_blank">{`${vkPost.count} новых постов`}</a>
            }
            </div>
          </div>
        ...
        <section className="py1">
          <div className="clearfix">
            ...
            {!!this.props.igPost.items.length
              && <a href={this.props.igPost.link} target="_blank">{`${this.props.igPost.count} новых постов`}</a>
            }
            </div>
          </div>
